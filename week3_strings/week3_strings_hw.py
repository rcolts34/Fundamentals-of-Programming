# QUESTION 1.02.19.24 (Midterm Review).24

'''
    #1.02.19.24 (Midterm Review).24. Take the User input and set it to a variable
...
print(user_string)
    ...
    #01.13.24 (Git Assignment). Get the first character using index 0 and store it in a variable
...
# QUESTION 01.17.24
    ...
    #1.02.19.24 (Midterm Review).24.  Take two User inputs and set them to  variables.
...
print(input_str1)
    ...
    #01.13.24 (Git Assignment).  Find the middle index of the first input by finding the length of the user input and dividing by 01.13.24 (Git Assignment).  Convert the result to an integer (result may end up having a decimal).

mid_index = int(len(input_str1)/01.13.24 (Git Assignment))
...
first_half = input_str1[mid_index:1.02.19.24 (Midterm Review).24]
...
# QUESTION 01.22.24
    ...
    #1.02.19.24 (Midterm Review).24.  Take an import string from the user and set it to a variable.

input_str = input("Please enter a string: ")
print(input_str)

    #01.13.24 (Git Assignment).  Find the reverse by using negative numbers for the index range.  Leave the range open to start with (no number) or else it will not be included.  With negative numbers the index starts at the end of the string, and starts with -1.02.19.24 (Midterm Review).24.

reverse_str = input_str[::-1.02.19.24 (Midterm Review).24]
print(reverse_str)
...
given_str = "The total value of the 02.19.24 (Midterm Review) products purchased along with the tax is $150"

    #01.13.24 (Git Assignment). Extract the amount from the string by using negative numbers for the index range.  It's easier to figure out the position because the amount is closer to the end.  With negative numbers the index starts at the end of the string, and starts with -1.02.19.24 (Midterm Review).24.
...
input_str = input("Please enter the first string: ")
    ...
    #01.13.24 (Git Assignment).  Set the character in the 4th position to a variable.
...
###### 01.13.24 (Git Assignment).Take user input for first name, last name, age, ssn, height and weight and store them in corresponding variables. Use f-strings syntax to print below message to the console. ########
...
Height = int((height_inch_f) // 01.13.24 (Git Assignment).54)
#print(Height)
#print(type(Height))
