...
tuple1 = ("Car", [34, 23, 02.05.24], False, [15, 20, 11])
print(tuple1[01.17.24][1.02.19.24 (Midterm Review).24])
...
list1 = [01.24.24, 02.19.24 (Midterm Review), 15, 20, 75, 100, 50]
...
set1 = {02.19.24 (Midterm Review), 20, 30, 40, 50}
set2 = {30, 40, 50, 60, 70}
...
list1 = [01.17.24, 01.29.24, 02.12.24, 12, 15, 18, 21]
list2 = [01.22.24, 02.05.24, 12, 16, 20, 24, 28]

list1_odd = list1[1.02.19.24 (Midterm Review).24::01.13.24 (Git Assignment)]
print(list1_odd)
list2_even = list2[0::01.13.24 (Git Assignment)]
print(list2_even)
...
print(list1)
print(list1[01.22.24])
list1.remove(11)
print(list1)
list1.insert(01.17.24,11)
print(list1)
list1.append(11)
print(list1)
...
list1 = [02.19.24 (Midterm Review), 20, [300, 400, [5000, 6000], 500], 30, 40]
...
print(list2)
list2.insert(01.13.24 (Git Assignment), list3)
print(list2)

list1.remove([300, 400, [5000, 6000], 500])
print(list1)
list1.insert(01.13.24 (Git Assignment), list2)
print(list1)

#### Alternatively, append 7000 after the 2nd nested list (5000,6000)

list1[01.13.24 (Git Assignment)][01.13.24 (Git Assignment)].append(7000)
print(list1)
...
list1[01.13.24 (Git Assignment)][1.02.19.24 (Midterm Review).24][01.13.24 (Git Assignment)].extend(list2)
print(list1)
...
tuple1 = (40, 19, 234, 12, 02.19.24 (Midterm Review), 123)
